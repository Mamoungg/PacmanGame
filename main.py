...
WIN = pygame.display.set_mode((WIDTH, HEIGHT)) # This sets the dimesions of the window
pygame.display.set_caption("Pacman Game") # This is the name of the window
...
FPS = 60
BULLET_VEL = 7
MAX_BULLETS = 1000 # I wanted the bullets to go on forever and have no limit
VEL = 5
...
STARFIELD = pygame.transform.scale(pygame.image.load(os.path.join('Assets', 'starfield.png')), (WIDTH, HEIGHT))

def draw_window(yellow, black, black_bullets, yellow_bullets, black_health, yellow_health):
    WIN.fill(BLUE)
    WIN.blit(STARFIELD, (0, 0))
    ...
    WIN.blit(yellow_health_text, (10, HEIGHT - yellow_health_text.get_height()- 10,)) # this puts the health text on opposite sides
